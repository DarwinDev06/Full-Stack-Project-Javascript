    ...
    return (
        <div 
            ...
            <figure className='relative mb-2 w-full h-4/5'>
                ...
                <div 
                    className='absolute top-0 right-0 flex justify-center bg-white w-6 h-6 rounded-full m-2 ' onClick={() => context.setCount(context.count + 1) }>
